...
## Где создать ваше сообщество и вашу встречу?
...
Если, однако, сообщество Биткойна существует, но не активно, может быть более актуально взять его на себя и вновь зажечь его пламя; связавшись, например, с его бывшими создателями с целью получения доступа к ранее использованным каналам связи и социальным сетям.
...
Теперь ваша задача - **найти значимый элемент или место в вашем городе и использовать его для создания визуала для вашего Bitcoin сообщества**.
...
# Создание каналов связи для вашего Bitcoin сообщества
...
- размещение на одном или нескольких столах **стикеров, листовок или даже материалов, которые могут привести к обсуждению** (Nerdminer, стальная пластина, аппаратный кошелек, включенный компьютер с mempool, ASIC, металлическая пластина для защиты вашего приватного ключа и т.д.)
...
| ---------------- | ---------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------------------- | --- |
| Сентябрь         | Глава 1: Что такое Bitcoin?                                | [YT](https://www.youtube.com/watch?v=CSjuBqrl4t8) | [canva](https://www.canva.com/design/DAFu0d5Jd7M/9gAWDAOSS6LDkWENuZjYgw/edit) |
| Октябрь & Ноябрь | Глава 2: Понимание транзакций в Bitcoin                    | [YT](https://www.youtube.com/watch?v=inFnR-3NsdM) | [canva](https://www.canva.com/design/DAFsEcnOro8/Mz9FYdTGhsvozZOe0Y9jtw/edit) |     |
...
- **организация приезда эксперта в определенной области или компании**, предлагающей релевантный продукт, связанный с Bitcoin;
- **вечер "бар и коммерция"**, принимающий Bitcoin в качестве способа оплаты;
- и т.д.
...
- **семейное мероприятие вокруг Bitcoin** и принципов его работы. Можно привлечь игры вроде ["Le Coin de Table"](https://www.maximalist.ovh/) или ["SHAmory"](https://shamory.com/);
...
Как символы идентичности вашего сообщества, может быть интересно спроектировать, а затем заказать стикеры.
...
- наконец - и это немного технически - если вы хотите насыщенный черный цвет печати («четырехцветный черный»), свойства этого должны быть: 30% голубого, 30% пурпурного, 30% желтого и 100% черного. В случаях, когда используется только 100% черный, результат будет скорее серовато-черным. К счастью, типографии обычно обращают внимание на эту деталь. Так что, слишком много беспокоиться об этом не стоит.
  ![image](assets/fr/chapter25/38.webp)

####

В зависимости от вашего запроса и выбранного поставщика, ожидайте, что вы заплатите **между 100 и 250 евро за 1000 стикеров**. Вы также можете связаться с [@Mill3sim3 в Twitter](https://x.com/Mill3sim3), французским биткоинером, специализирующимся на маркетинге, который может помочь вам получить цены почти на 30% дешевле, чем обычные онлайн-сайты. Не стесняйтесь обращаться к нему за этим.

Однако стоит отметить, что 1000 стикеров - это значительное количество. Поэтому явно **предпочтительнее сначала оптовать за покупку сотни стикеров**; чтобы быть уверенным в продаже этого запаса.
Также, маленькое замечание: **если вы решите наклеить один из этих стикеров на улице, в зависимости от страны, это может быть запрещено законом**. Например, во Франции запрещено наклеивать стикеры на улице, за исключением общественных досок объявлений, присутствующих в каждом городе. Это означает, что если один из ваших стикеров будет наклеен небрежно (или скорее: где попало, например, на середине знака остановки), его быстро уберут; и если на нем будет информация, которую можно отследить до вашей личности или личности вашей встречи, не исключено, что вам может грозить штраф. Так что будьте осторожны и информируйте своих участников.

####

Параллельно, если вы увлекаетесь концертами, барами или стадионами, **подумайте о проверке, не наклеены ли уже стикеры перед тем, как разместить свой. В противном случае, рассмотрите возможность спросить сотрудника, разрешено ли это**.
Действительно, было бы печально, если бы торговец впервые услышал о вашем сообществе / встрече / ассоциации / Bitcoin из-за того, что вы испортили декор его туалетов!
...
Для этого вы можете попросить всех заинтересованных людей поделиться своими чтениями, принеся книгу, связанную с Bitcoin, и во время встречи, если кто-то еще заинтересован в ее заимствовании, **можно, например, оформить заем ее владельцу в обмен на депозит в 21,000 сатоши в Lightning**.
...
Если вы управляете **ассоциацией и хотите инвестировать часть вашего казначейства в образовательные и педагогические ресурсы**, вы можете заказать несколько книг и предложить их в вашей **библиотеке Bitcoin** на каждой встрече.
![image](assets/fr/chapter26/39.webp)

####

В этом отношении и с целью развития экосистемы, **[издательство Konsensus.Network](https://konsensus.network/) предлагает встречам и международным сообществам Bitcoin скидку от 15% до 35% на все свои книги; начиная с трех купленных**.

Если у вас нет казначейства, члены вашего сообщества все равно могут воспользоваться этой скидкой.
...
Кроме того, можно написать и выставить во время встреч хартию по заимствованию книг, кратко объясняющую правила заимствования.

Вот пример с открытым исходным кодом, который вы можете взять и изменить по своему усмотрению:
[Хартия по заимствованию книг](https://www.canva.com/design/DAF7u1b5kRM/r2gEAlibe_jTIXIX-O9PMA/edit)

![image](assets/fr/chapter26/40-fr.webp)

####

Параллельно, продолжая идею продвижения чтения о Bitcoin, еще одно значительное действие может заключаться в **посещении муниципальных библиотек города и проверке наличия у них различных книг о Bitcoin**.
...
- **участников ваших мероприятий**, с листовкой, конкретно объясняющей, как использовать и платить в Биткойне / Lightning; - и **новичков**, встреченных на улице, на вашем рабочем месте или на семейном обеде, с листовкой, резюмирующей основные преимущества Биткойна.
...
Несколько листовок уже **доступны в открытом доступе**, и другие будут созданы в ближайшие месяцы. Особенно их можно найти **в [Bitcoin Educational Toolkit от planB.network](https://planb.network/fr/resources/bet)**.
...
Изменяйте её, адаптируйте и затем делитесь как вам нравится. Однако, помните о цитировании ваших источников.
...
- [delivrez.fr](https://delivrez.fr/maps/fr_FR/); а также некоторые статьи в местной прессе.
  Размещение Белой книги по Биткойну в этих книгообменах имеет символическое значение. Однако для новичка это слишком сложно для понимания. Поэтому идея заключалась в **создании небольшого буклета, включающего**:
...
Во Франции, например, **режиссер документального фильма "Застрявшие", [Алана Медиавилла](https://twitter.com/AlanaMediavilla), согласилась позволить митапам страны показать ее документальный фильм в превью**; некоторые кадры взяты из сцен [фильма "Грязные монеты"](https://www.dirtycointhemovie.com/), который выйдет в 2024 году.
Французское сообщество биткойнеров затем взяло на себя инициативу **полностью перевести документальный фильм "Застрявшие"**, добавить французские субтитры и поделиться им со всеми митапами по всей стране. В течение недели с 4 марта 2024 года **был организован совместный показ примерно на десяти митапах по всей стране**.
![изображение](assets/fr/chapter28/47.webp)

Этот показ привел к многочисленным обсуждениям о майнинге Биткойна, его потреблении электроэнергии и более широком влиянии на экологию.

## Размещение плакатов в вашем городе

<chapterId>6565e8a0-d535-5be0-9764-273584c675bd</chapterId>

В нескольких европейских странах (Германия, Испания, Франция и т.д.), **некоторые биткоинисты взяли на себя инициативу размещать постеры, связанные с Биткойном**. На некоторых из этих постеров изображены работы Бэнкси, в то время как другие включают логотип Биткойна различными способами.
Это особенно касается [StreetCyberArt](https://twitter.com/streetcyber_art), биткоиниста из Германии, который на протяжении нескольких лет создает коллажи и уличное искусство.
...
Очевидно: **из виду - из ума**. Так что, в этом случае, возможно, стоит быть осторожным и не включать на эти постеры элементы, которые могут быть прослежены до вас (название встречи, @ Twitter и т.д.)

Если вы планируете **печатать такие постеры на личном принтере, имейте в виду, что это обычно приводит к сильному размазыванию бумаги, а также к ее быстрому ухудшению со временем**. В этом смысле **лучше всего, конечно, связаться с профессиональной типографией для производства этих постеров на специальной самоклеящейся бумаге, специально предназначенной для наружного использования**. Таким образом, качество будет обеспечено.
...
Как было сказано ранее, французский биткоинист [@Mill3sim3](https://twitter.com/Mill3sim3) имеет подходящее профессиональное оборудование. Поэтому вы можете связаться с ним в Twitter за информацией.
...
Чтобы упростить эту задачу создания, ниже приведенное руководство показывает вам за полчаса шаги по созданию **бесплатного веб-сайта на платформе WordPress**. Этот сайт позволит вам **иметь настраиваемую домашнюю страницу, создавать категории, публиковать статьи, интегрировать медиа (видео с YouTube, изображения, PDF-файлы)** и т. д.
...
Среди членов вашего сообщества некоторые могут быть заинтересованы в **создании мультимедийного контента**. Это может, например, принимать форму производства обучающих видео (использование программного кошелька, руководство по покупке BTC без KYC и т. д.)
Параллельно может наступить день, когда презентации будут проводиться на ваших встречах. Или даже, когда ваше сообщество проводит конференции в высших учебных заведениях и университетах.

В этом смысле, **когда возникает потребность, может быть актуальным иметь видеоканал, который позволяет вам публиковать онлайн все видео, презентации и конференции, проведенные в рамках ваших действий и проектов**.
...
В случае, если вы хотите **записывать на своем компьютере, программное обеспечение типа ["Streamlabs"](https://streamlabs.com/fr-fr) работает очень хорошо**. Оно позволяет настраивать множество параметров, бесплатно и также позволяет осуществлять переходы между сценами.

Что касается **видеомонтажа** (если он есть), вам потребуется подходящее программное обеспечение.
Если у вас еще нет, программное обеспечение ["Wondershare Filmora"](https://filmora.wondershare.fr/) особенно эффективно и очень просто в использовании; оно позволяет делать серьезные монтажи. К сожалению, оно платное (45 евро в год). Наконец, для **интро и аутро** вашего видео, конкретный поиск на **Canva** позволит вам найти то, что вы ищете, модифицировать результаты по вашему желанию, скачать их; и тогда все, что вам останется, это интегрировать их в ваше программное обеспечение для монтажа.
Примечание: в случае, если однажды Bitcoin будет запрещен или подвергнется цензуре, может быть актуально всегда **хранить локальную копию на жестком диске видео**, которые вы публикуете.

## Создание аудио подкаста

<chapterId>12e96b45-1c33-5687-a753-80d0114d487a</chapterId>

Создание аудио подкаста также может быть интересной инициативой. Однако, как и при создании видеоканала, не стоит ожидать быстрого получения тысяч просмотров.

Среди наиболее известных платформ для подкастов мы находим:

- [**Fountain**](https://www.fountain.fm/), которая особенно интересна тем, что позволяет принимать прямые пожертвования в Lightning;
...
Таким образом, после работы на "Spotify для подкастеров", остается только форматирование на ваших других платформах; что относительно быстро.

####

В случае, если вы хотели бы **записывать на вашем компьютере, бесплатное программное обеспечение, такое как ["Audacity"](https://www.audacityteam.org/), работает очень хорошо**. Оно позволяет настраивать множество параметров, выполнять крещендо и даже улучшать четкость звука во время редактирования. Таким образом, запись вашего голоса и последующее редактирование аудио вашего подкаста должны быть довольно простыми.

Вот короткое руководство, представляющее, за 10 минут, основные функции, которые нужно знать для создания подкаста с Audacity.
![Руководство по созданию подкаста с Audacity](https://www.youtube.com/watch?v=z471_Ye6Y0I)

Примечание: как упоминалось ранее, в случае, если однажды Bitcoin будет запрещен или подвергнется цензуре, может быть актуально всегда **хранить локальную копию на жестком диске подкастов**, которые вы публикуете.
...
Еще один момент на совершенно другую тему - это позиция по поводу **смерти члена вашего сообщества Bitcoin**.
К сожалению, может наступить день, когда семья одного из ваших бывших членов свяжется с вами, чтобы сообщить, что этот человек умер. Затем они объяснят, что **этот индивид оставил инструкции**, и одна из них - **связаться с вашим сообществом / встречей / ассоциацией**.
Этот человек, вероятно, объяснит, что им **нужна помощь в восстановлении средств**, так как они являются наследником этого бывшего члена.

В ответ на этот запрос может быть очень актуально **заранее подумать о некой процедуре, которой следует придерживаться**; и это по нескольким причинам.
С одной стороны:
...
- чтобы семья четко понимала, что **их присутствие связано с изучением Bitcoin**, чтобы в конечном итоге стать суверенными над средствами умершего;
...
Прежде всего, вы, безусловно, знаете, что **один из лучших способов рассказать о Bitcoin максимально большому количеству людей одновременно - это, очевидно, проведение конференции** (или семинара). Это можно сделать **в рамках высших учебных заведений и университетов**; таким образом, привлекая молодых (и, возможно, не очень молодых) людей к открытию или углублению их понимания Bitcoin.
...
Так что, если вы чувствуете себя способным: дерзайте! Наш мир так нуждается в образовании о том, что такое Bitcoin...
...
В случае послебакалаврской школы также возможно **напрямую связаться с ответственным за учебную программу**, с целью объяснения вашего предложения. Это может привести к первой встрече и – в лучшем из миров, через несколько недель – к презентации о том, что такое Bitcoin и как он работает перед студентами.

####

К сожалению, в нашем современном мире Bitcoin все еще слишком часто намеренно демонизируется СМИ и политиками; заставляя многих новичков думать, что его следует запретить в классах и лекционных залах. **Вероятность того, что вы столкнетесь с множеством отказов, поэтому довольно высока**; особенно в академической сфере, где доказательство работы Bitcoin и потребление энергии иногда кажутся табу.
Однако, это не мешает вам попытаться, особенно с BDE и студенческими ассоциациями. **С немного удачи, даже если отказ будет твердым в первый раз, не исключено, что вас снова свяжутся во время следующего бычьего рынка на электронный адрес вашего сообщества, чтобы провести конференцию перед почти 280 студентами!**
...
Достижение цели **принятия Bitcoin в качестве метода оплаты торговцем** является своего рода "святым Граалем" для многих энтузиастов Bitcoin. Это как открытие нового достижения в их Pokédex! Однако, поскольку каждый торговец уникален, эта задача не из легких; и возникает множество проблем:
...
Таким образом, развитие экосистемы Bitcoin в вашем городе может включать в себя **привлечение торговцев**. Для этого самый простой способ - **действовать пошагово**:

1. как только вы заходите в магазин, **всегда спрашивайте, можно ли оплатить в Bitcoin**. Обычно это приводит к отказу и удивленному взгляду, но этот простой вопрос постепенно заставляет торговцев видеть, что Bitcoin может использоваться "обычными людьми" и что он привлекает интерес как метод оплаты среди населения. Вы даже можете **поручить двум-трем людям посетить один и тот же магазин через несколько дней, спрашивая об оплате в Bitcoin**. В какой-то момент это привлечет внимание торговца;

2. как только они заинтересуются или спросят, что такое Bitcoin, вы можете **кратко и простыми словами объяснить им**. Например, что Bitcoin - это валюта, не контролируемая банками, без доверенного посредника, что она не подвержена цензуре, не подвержена инфляции, и что комиссии ниже, чем в традиционной банковской системе. Затем вы можете **дать им листовку**, например, "21 причина использовать Bitcoin" и/или "10 причин принять Bitcoin в вашем магазине", а затем **дать им ваш контакт или контакт вашей встречи**. Таким образом, когда они заинтересуются демонстрацией, они смогут связаться с вами.

3. как только этот человек решит принять Bitcoin, **организация встречи с ним для демонстрации предлагаемого вами программного решения кажется уместной**. **[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** представляет собой отличное решение в этом отношении, потому что:

- это позволяет торговцам, желающим конвертировать свои ежедневные доходы в Bitcoin в фиатную валюту, тем самым давая им возможность оплачивать поставщиков;
- это также позволяет, при желании, сохранять определенный процент дохода в BTC;
- это позволяет экспортировать учет всех платежей в Bitcoin для отправки их бухгалтерам, тем самым облегчая их работу;
- у него дружелюбная панель управления для менеджера;
...
4. **когда этот бизнес принимает Bitcoin**, вам будет возможно:

- **регулярно посещать** для совершения покупок;
...
- но также и **возможность проведения в этом бизнесе мероприятий**, таких как встречи или семинары.
...
Очень часто забываемый, мы, биткойнеры, обычно думаем, что лучшими средствами коммуникации являются социальные сети и интернет. Но мы – отчасти – ошибаемся.
...
Отзывы от Breizh Bitcoin ясны: это работает хорошо, и новые люди посетили их встречи после того, как узнали об их ассоциации в газете.
...
Однако, будьте осведомлены, что слова в СМИ могут легко быть истолкованы в их невыгоду. **Так что, это не легкая задача, и, возможно, будет мудро к ней подготовиться**.
...
В реализации этих, **три совета** могут вас направить:

1. **заранее определите этапы проекта, его цель(и) и что нужно сделать**;
2. **действуйте шаг за шагом, не позволяя себе унывать**; 3) и, прежде всего, **просите о помощи и поддержке у своих участников и других сообществ вокруг вас**.

Имейте в виду, что **каждое сообщество и каждая встреча проходили через те же этапы, через которые проходите вы**. Поэтому не стесняйтесь **просить их о совете**.
...
1. **ваши каналы связи (Telegram, Signal, Matrix и т.д.) заполнятся, потенциально делая беседы трудными для отслеживания**. Здесь следует рассмотреть два момента.
   С одной стороны, если вы 500 человек обсуждаете разные темы в одном канале обсуждения, большинство ваших участников постепенно перестанут следить за беседами; в том числе из-за обилия сообщений для чтения и связанных с ними уведомлений. В этом смысле может быть актуально **переосмыслить ваши каналы связи; как, например, супергруппы Telegram или даже сервер Discord**, которые оба позволяют группировать беседы по темам.
   С другой стороны, больше людей в каналах обмена также означает больше ботов, больше мошенничества и также **больше модерации**. Вам, следовательно, нужно будет быть готовыми, например, составив набор правил, на которые вы можете опираться при модерации сообщения. Из опыта это избегает большую часть конфликтов; особенно когда правила доступны для чтения в ваших каналах связи. В этом смысле ассоциация Bitcoin Lille несколько лет назад написала **[открытый набор правил](https://bitcoinlille.fr/reglement/) для своей группы Telegram и своего сервера Discord**, основанный на простых и универсальных принципах. Его дизайн [также доступен](https://www.canva.com/design/DAGHI692AD4/rjT4sqEnhajc5FiPA6GFZQ/edit?utm_content=DAGHI692AD4&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).
...
К сожалению, необходимо сказать, что **на встречи могут приходить мошенники**. Их целью тогда будет как можно больше говорить о своей пирамиде, MLM или "революционном блокчейн-проекте". Также вполне вероятно, что люди с злыми намерениями могут прийти специально для отмывания денег или для покупки BTC фальшивыми купюрами.
...
Вы организатор встречи и, в одночасье, **решаете прекратить это занятие**, чтобы уехать разводить лам в Перу; просто оставив все позади?
...
**Так что предвидите ваш возможный отъезд** в Перу. И если у вас во Франции нет доверенного члена в вашей встрече, вы всегда можете связаться с @ProfEduStream или @gabtribe в Telegram, чтобы сделать этот переход гладким.

####

Это подводит нас к **ключевой точке в развитии сообщества: его децентрализации**.
Действительно, если вы единственный человек, участвующий в нем, имеющий все контроли, что произойдет, если вы исчезнете? Ответ прост: ваше сообщество исчезнет.

Лучший способ избежать этого - **децентрализовать задачи и поделиться правами, ролями и доступом**. Таким образом, если один из организаторов вашего сообщества или встречи будет арестован в будущей дистопии из-за владения неконтролируемым Bitcoin (или просто: потому что у него больше нет времени, посвященного этому, потому что у него только что родился ребенок или он сменил работу), другие могут продолжать их миссии без трудностей.

####

В целях дальнейшей децентрализации **использование программного обеспечения с открытым исходным кодом, такого как набор инструментов framasoft**, также может служить первой "линией обороны" против государства, которое бы цензурировало Bitcoin. Использование зашифрованных - даже анонимных - средств коммуникации является вторым.

## Что если Bitcoin станет общественным врагом номер один?

<chapterId>c739651f-cd13-51e0-a36e-85023749b15b</chapterId>

5 апреля 1933 года Франклин Рузвельт, тогдашний 32-й президент Соединенных Штатов Америки, подписал исполнительный приказ 6102, запрещающий любому лицу владеть золотыми монетами, золотыми слитками и золотыми сертификатами на всей территории.

![image](assets/fr/chapter37/60-enbis.webp)

Очевидно, что Великая депрессия (крах фондового рынка 1929 года) сегодня уже не актуальна. Но кто может сказать, что завтра другое государство не сделает то же самое и **не запретит любому лицу владеть bitcoin?**

####

К счастью, эта оруэлловская дистопия не помешает никому действительно владеть своими биткойнами, поскольку невозможно остановить кого-либо от запоминания последовательности слов.
Но что произойдет, **если лидеры нашего мира наконец поймут, что Bitcoin имеет способность изменить мировой порядок, включая на государственном уровне?** Станет ли тогда Bitcoin **"общественным врагом номер один"?**

####

Конечно, мы не должны поддаваться форме конспирологического мышления. Но **ничто не мешает нам, с этого момента, антиципировать, децентрализовать и обучать**.
...
## Суммированный план действий для создания вашего сообщества Bitcoin
...
Как вы уже поняли из этого курса, **создание сообщества и встречи по Биткойну** требует организации и мотивации. Конечно, в зависимости от ваших желаний и времени, которое вы можете ему посвятить, вы будете продвигаться в проектах более или менее далеко.
Тем не менее, цель остается той же: **зажечь искру для роста Биткойна в вашем городе**.

####

Чтобы подвести итог многим главам и подглавам этого курса, вот **"план действий" для создания вашего сообщества Биткойна**:

1. заранее решите, зачем вы хотите создать сообщество Биткойна, с какой целью, где и т.д.;
2. приблизьтесь к уже установленным сообществам вокруг вас, связавшись с ними и/или попросив совета;
...
5. подходите к соседним встречам и сообществам (особенно в социальных сетях) и регистрируйтесь на различных картах и платформах для повышения видимости;

Как только каналы связи вашего сообщества будут достаточно развиты:

6. предложите собрание типа встречи через опрос;
7. подумайте о целях, которые вы хотите достичь с этого физического мероприятия;
8. ищите хорошо расположенное, приветливое место, которое соответствует вашим целям, и забронируйте столик;
...
13. Предлагайте идеи проектов и простые инициативы, и начинайте реализовывать те, которые лично для вас важны. Если кто-то другой хочет наладить что-то другое, не стесняйтесь помочь в зависимости от задачи и желаемой цели;
    Наконец:
...
Когда ваше сообщество чувствует готовность перейти на следующий уровень, **возможно создание ассоциации**.
...
- с одной стороны, статус ассоциации позволяет **иметь официальный статус, открыть ассоциативный банковский счет, а также получить форму признания от прессы, СМИ и субсидий**;
...
Через него **мы также подробно рассмотрим другой важный аспект: организацию масштабных мероприятий, с участием около сотни участников**. Мы затронем вопросы такие как: Почему? Какая организация? Где? Какой бюджет? Как? Какая операция?
...
Когда кто-то падает в кроличью нору, наше восприятие многих вещей меняется.
Это затем подталкивает нас к желанию идти дальше, к желанию открыть для себя тех других людей, которые занимаются тем же умственным трудом, что и мы, и которые тоже поняли.
Это мотивирует нас, дает нам еще больше желания **внести свой вклад в строительство** и поделиться нашим открытием: Биткойном.
Это также заставляет нас **думать о мире завтрашнего дня, о том, который мы хотим построить, и о сообществах, которые в процессе его создания**.

####

**В этой долгой галерее, которая является созданием сообщества, вам нужно будет проявить мотивацию, стратегию, самопожертвование и время**. Это иногда неблагодарная задача; и в этом стремлении лучше делать вещи постепенно, чтобы не навредить себе.
**Так что подумайте о себе, о своих пределах**. И хотя Биткойн может вас вдохновлять ночью и днем, **не пытайтесь делать все самостоятельно; иначе вы истощитесь**.

Наоборот, **попросите о помощи биткойнеров, которые уже прошли через эту же галерею, которые уже исследовали те же вопросы и построили те же инструменты**. Это сэкономит вам огромное количество времени.

**Также предложите людям, которые последуют за вами в этом приключении, помочь вам, даже если это означает делегирование некоторых задач**, и что эти задачи могут занять больше времени. В долгосрочной перспективе ваше сообщество выйдет единым и более зрелым.

![image](assets/fr/chapter39/63.webp)
В одиночку можно быстро исследовать одну из многих галерей биткоин-кроличьей норы, пока не дойдешь до ее конца. Но потом предстоит обратный путь. А затем — исследование всех остальных направлений. В то время как **создавая и/или присоединяясь к сообществу биткоинеров, регулярно делясь с ними информацией и обмениваясь ею, вы будете исследовать все направления биткоин-кроличьей норы одновременно**.

Тогда, гораздо быстрее, чем если бы вы делали это в одиночку, вы сможете сказать: "Я понял Биткоин".
